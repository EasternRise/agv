...
struct PPoly
{
  ...
  fp64  Gyro_Convert1=1.5733821965;    //第二版车正转系数583312
  fp64  Gyro_Convert2=1.5733669666;    //第二版车反转系数
  fp64  Gyro_Convert= (1.5733821965+1.5733669666)/2;
...
void Gyro_Update(void)
{
    ...
    Gyro_Total_NoFloat=Gyro_Total-Gyro_Now.count*Gyro_Float;
    Gyro_NoFloat=Gyro_Now.value-Gyro_Float;
    
	//Gyro_Multiplier=PPoly_Eval(fabs(1000*Gyro_Radian_Step/time_interval),GREENGYRO);
	Gyro_Multiplier=1.0;
//      if(Int32Abs(Gyro_NoFloat)<1000)
//          Gyro_Angle_Total+=Gyro_Convert*(Gyro_Now.value - Gyro_Float)*0.0000001*Gyro_Multiplier;
     if(Gyro_Now.value > Gyro_Float)
        Gyro_Angle_Total+=Gyro_Convert1*(Gyro_Now.value - Gyro_Float)*0.0000001*Gyro_Multiplier;
    else
        Gyro_Angle_Total+=Gyro_Convert2*(Gyro_Now.value - Gyro_Float)*0.0000001*Gyro_Multiplier;        
}
...
void Gyro_Init_P(void)
{
	...
	//Gyro_Convert1=3600*1000000.0/(fp64)Gyro_Total_NoFloat;
}
void Gyro_Init_N(void)
{
	Gyro_Convert2=-3600*10000000.0/(fp64)Gyro_Total_NoFloat;
	//Gyro_Convert2=-3600*1000000.0/(fp64)Gyro_Total_NoFloat;
    Gyro_Convert=(Gyro_Convert1+Gyro_Convert2)/2;
}
