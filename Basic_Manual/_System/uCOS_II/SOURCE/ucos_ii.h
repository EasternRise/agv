...
extern int OSIntCtxSw(void);
extern int OSStartHighRdy(void);
extern int OSCtxSw(void);
...
typedef struct os_event {
    ...
    INT8U    OSEventName[OS_EVENT_NAME_SIZE];/*事件控制块的名称*/
#endif
} OS_EVENT;
#endif
...
INT8U         OSMboxPost            (OS_EVENT        *pevent, 
                                     void            *msg);
INT8U         OSMboxPost1    		(OS_EVENT        *pevent, 
                                     void            *msg);
INT8U         OSMboxPost2	      	(OS_EVENT        *pevent, 
                                     void            *msg);
#endif
