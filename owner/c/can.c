...
//     CAN_FilterInitStructure.CAN_FilterIdHigh = 0x02;
//     CAN_FilterInitStructure.CAN_FilterIdLow = 0x02;
//     CAN_FilterInitStructure.CAN_FilterMaskIdHigh = 0x8f;
//     CAN_FilterInitStructure.CAN_FilterMaskIdLow = 0x8f;
...
// //                id_temp = (uint16_t)(Can_Database[i].Data_ID);
...
void Can_GPIO_Config(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12;					 //PA12:CAN1-TX 
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;			 //瀻用模蕼
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOA, &GPIO_InitStructure);	
}
