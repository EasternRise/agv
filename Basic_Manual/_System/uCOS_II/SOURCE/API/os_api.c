...
//*------------------------------------------------------------------------------------------------
uint8 OSAPISemWait(HANDLER hSem, uint16 uwWaitMS)
{
	uint16	__uwDelayTicks;
	uint8	__ubRtnVal;
...
//*------------------------------------------------------------------------------------------------
HANDLER OSAPIBlockNew(uint8 ubPIP)
{
	uint8		__ubErr;
...
//*			: - OS_ERR_PEVENT_NULL: hSem是一个空指针
//*------------------------------------------------------------------------------------------------
uint8 OSAPIBlockEnter(HANDLER hBlock, uint16 uwWaitMS)
{
	uint16	__uwDelayTicks;
	uint8	__ubRtnVal;
